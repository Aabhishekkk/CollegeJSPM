...
</div>`}};t(Je,"CustomerDialog"),Je=y([Qo.registerClass("Serenity.Demo.Northwind.CustomerDialog"),Qo.panel()],Je);import{Decorators as Bo,EntityGrid as Gs}from"@serenity-is/corelib";var Mt=class extends Gs{getColumnsKey(){return lt.columnsKey}getDialogType(){return Je}getRowDefinition(){return F}getService(){return pt.baseUrl}};t(Mt,"CustomerGrid"),Mt=y([Bo.registerClass("Serenity.Demo.Norhtwind.CustomerGrid"),Bo.filterable()],Mt);import{Decorators as Ko,EntityDialog as Qs}from"@serenity-is/corelib";var Ve=class extends Qs{constructor(){super(...arguments);this.form=new Me(this.idPrefix)}getFormKey(){return Me.formKey}getRowDefinition(){return S}getService(){return Re.baseUrl}};t(Ve,"ProductDialog"),Ve=y([Ko.registerClass(),Ko.maximizable()],Ve);import{Decorators as Xo,EntityGrid as Bs,LookupEditor as Ks}from"@serenity-is/corelib";import{deepClone as Xs,first as ze,formatNumber as nr,htmlEncode as Nt,notifyError as Jo,parseDecimal as Js,parseInteger as Vs,parseQueryString as zs,serviceRequest as Ws,localText as Vo,toId as $s,trimToNull as js,tryFirst as Ys}from"@serenity-is/corelib/q";import{ExcelExportHelper as Zs,PdfExportHelper as el}from"@serenity-is/extensions";var fe=S.Fields,Ht=class extends Bs{constructor(e){super(e);this.pendingChanges={};this.slickContainer.on("change",".edit:input",o=>this.inputsChange(o))}getColumnsKey(){return ft.columnsKey}getDialogType(){return Ve}getRowDefinition(){return S}getService(){return Re.baseUrl}getButtons(){var e=super.getButtons();return e.push(Zs.createToolButton({grid:this,service:Re.baseUrl+"/ListExcel",onViewSubmit:()=>this.onViewSubmit(),separator:!0})),e.push(el.createToolButton({grid:this,onViewSubmit:()=>this.onViewSubmit(),reportTitle:"Product List",columnTitles:{Discontinued:"Dis."},tableOptions:{columnStyles:{ProductID:{cellWidth:25,halign:"right"},Discountinued:{cellWidth:25}}}})),e.push({title:"Save Changes",cssClass:"apply-changes-button disabled",onClick:o=>this.saveClick(),separator:!0}),e}onViewProcessData(e){return this.pendingChanges={},this.setSaveButtonState(),super.onViewProcessData(e)}numericInputFormatter(e){if(e.item.__nonDataRow)return Nt(nr(e.value,"#0.##"));var o="edit numeric",s=e.item,a=this.pendingChanges[s.ProductID];a&&a[e.column.field]!==void 0&&(o+=" dirty");var d=this.getEffectiveValue(s,e.column.field);return"<input type='text' class='"+o+"' data-field='"+e.column.field+"' value='"+nr(d,"0.##")+"'/>"}stringInputFormatter(e){if(e.item.__nonDataRow)return Nt(e.value);var o="edit string",s=e.item,a=this.pendingChanges[s.ProductID],d=e.column;a&&a[d.field]!==void 0&&(o+=" dirty");var m=this.getEffectiveValue(s,d.field);return"<input type='text' class='"+o+"' data-field='"+d.field+"' value='"+Nt(m)+"' maxlength='"+d.sourceItem.maxLength+"'/>"}selectFormatter(e,o,s){if(e.item.__nonDataRow)return Nt(e.value);var a="edit",d=e.item,m=this.pendingChanges[d.ProductID],N=e.column;m&&m[o]!==void 0&&(a+=" dirty");var le=this.getEffectiveValue(d,o),J="<select class='"+a+"' data-field='"+o+"' style='width: 100%; max-width: 100%'><option value=''>--</option>";for(var b of s.items){let ye=b[s.idField];J+="<option value='"+Nt(ye)+"'",ye==le&&(J+=" selected"),J+=">"+Nt(b[s.textField])+"</option>"}return J+"</select>"}getEffectiveValue(e,o){var s=this.pendingChanges[e.ProductID];return s&&s[o]!==void 0?s[o]:e[o]}getColumns(){var e=super.getColumns(),o=t(m=>this.numericInputFormatter(m),"num"),s=t(m=>this.stringInputFormatter(m),"str");ze(e,m=>m.field==="QuantityPerUnit").format=s;var a=ze(e,m=>m.field===fe.CategoryName);a.referencedFields=[fe.CategoryID],a.format=m=>this.selectFormatter(m,fe.CategoryID,L.getLookup());var d=ze(e,m=>m.field===fe.SupplierCompanyName);return d.referencedFields=[fe.SupplierID],d.format=m=>this.selectFormatter(m,fe.SupplierID,O.getLookup()),ze(e,m=>m.field===fe.UnitPrice).format=o,ze(e,m=>m.field===fe.UnitsInStock).format=o,ze(e,m=>m.field===fe.UnitsOnOrder).format=o,ze(e,m=>m.field===fe.ReorderLevel).format=o,e}inputsChange(e){var o=this.slickGrid.getCellFromEvent(e),s=this.itemAt(o.row),a=$(e.target),d=a.data("field"),m=js(a.val()),N=this.pendingChanges[s.ProductID],le=this.getEffectiveValue(s,d),J;a.hasClass("numeric")?J=nr(le,"0.##"):J=le;var b;if(d==="UnitPrice"){if(b=Js(m!=null?m:""),b==null||isNaN(b)){Jo(Vo("Validation.Decimal"),"",null),a.val(J),a.focus();return}}else if(a.hasClass("numeric")){var ye=Vs(m!=null?m:"");if(isNaN(ye)||ye>32767||ye<0){Jo(Vo("Validation.Integer"),"",null),a.val(J),a.focus();return}b=ye}else a.is("select")?b=$s(a.val()):b=m;N||(this.pendingChanges[s.ProductID]=N={}),N[d]=b,s[d]=b,this.view.refresh(),a.hasClass("numeric")&&(b=nr(b,"0.##")),a.val(b).addClass("dirty"),this.setSaveButtonState()}setSaveButtonState(){this.toolbar.findButton("apply-changes-button").toggleClass("disabled",Object.keys(this.pendingChanges).length===0)}saveClick(){if(Object.keys(this.pendingChanges).length!==0){var e=Object.keys(this.pendingChanges),o=-1,s=this;t(function a(){if(++o>=e.length){s.refresh();return}var d=e[o],m=Xs(s.pendingChanges[d]);m.ProductID=d,Ws(Re.Methods.Update,{EntityId:d,Entity:m},N=>{delete s.pendingChanges[d],a()})},"saveNext")()}}getQuickFilters(){var e=super.getQuickFilters(),o=zs();if(o.cat){var s=Ys(e,a=>a.field=="CategoryID");s.init=a=>{a.element.getWidget(Ks).value=o.cat}}return e}};t(Ht,"ProductGrid"),Ht=y([Xo.registerClass(),Xo.filterable()],Ht);import{Decorators as tl,EntityDialog as rl}from"@serenity-is/corelib";var We=class extends rl{constructor(){super(...arguments);this.form=new He(this.idPrefix)}getFormKey(){return He.formKey}getRowDefinition(){return M}getService(){return vt.baseUrl}};t(We,"RegionDialog"),We=y([tl.registerClass("Serenity.Demo.Northwind.RegionDialog")],We);import{Decorators as ol,EntityGrid as il}from"@serenity-is/corelib";var Gt=class extends il{getColumnsKey(){return ht.columnsKey}getDialogType(){return We}getRowDefinition(){return M}getService(){return vt.baseUrl}};t(Gt,"RegionGrid"),Gt=y([ol.registerClass("Serenity.Demo.Northwind.RegionGrid")],Gt);import{Decorators as nl,EntityDialog as al}from"@serenity-is/corelib";var $e=class extends al{constructor(){super(...arguments);this.form=new Ge(this.idPrefix)}getFormKey(){return Ge.formKey}getRowDefinition(){return H}getService(){return xt.baseUrl}};t($e,"ShipperDialog"),$e=y([nl.registerClass()],$e);import{Decorators as sl,EntityGrid as ll}from"@serenity-is/corelib";var Qt=class extends ll{getColumnsKey(){return gt.columnsKey}getDialogType(){return $e}getRowDefinition(){return H}getService(){return xt.baseUrl}};t(Qt,"ShipperGrid"),Qt=y([sl.registerClass()],Qt);import{Decorators as pl,EntityGrid as dl}from"@serenity-is/corelib";var Bt=class extends dl{getColumnsKey(){return Dt.columnsKey}getDialogType(){return De}getRowDefinition(){return O}getService(){return yt.baseUrl}};t(Bt,"SupplierGrid"),Bt=y([pl.registerClass("Serenity.Demo.Northwind.SupplierGrid")],Bt);import{Decorators as ul,EntityDialog as cl}from"@serenity-is/corelib";var je=class extends cl{constructor(){super(...arguments);this.form=new Qe(this.idPrefix)}getFormKey(){return Qe.formKey}getRowDefinition(){return G}getService(){return Rt.baseUrl}};t(je,"TerritoryDialog"),je=y([ul.registerClass("Serenity.Demo.Northwind.TerritoryDialog")],je);import{Decorators as ml,EntityGrid as fl}from"@serenity-is/corelib";var Kt=class extends fl{getColumnsKey(){return St.columnsKey}getDialogType(){return je}getRowDefinition(){return G}getService(){return Rt.baseUrl}};t(Kt,"TerritoryGrid"),Kt=y([ml.registerClass("Serenity.Demo.Northwind.TerritoryGrid")],Kt);export{nt as CategoryColumns,Se as CategoryDialog,Pe as CategoryForm,Ft as CategoryGrid,te as CategoryLangRow,Co as CategoryLangService,L as CategoryRow,at as CategoryService,lt as CustomerColumns,re as CustomerCustomerDemoRow,oe as CustomerDemographicRow,ie as CustomerDetailsRow,Je as CustomerDialog,Oe as CustomerEditor,Ie as CustomerForm,Mt as CustomerGrid,de as CustomerGrossSalesRow,Ke as CustomerOrderDialog,Xe as CustomerOrdersGrid,ue as CustomerRepresentativesRow,F as CustomerRow,pt as CustomerService,Le as EmployeeFormatter,st as EmployeeListFormatter,K as EmployeeRow,ne as EmployeeTerritoryRow,ut as FreightFormatter,Ur as Gender,xe as NoteDialog,ae as NoteRow,we as NotesEditor,ct as OrderColumns,mt as OrderDetailColumns,_e as OrderDetailDialog,Ae as OrderDetailForm,X as OrderDetailRow,_o as OrderDetailService,ke as OrderDetailsEditor,ge as OrderDialog,qe as OrderForm,Be as OrderGrid,A as OrderRow,Ue as OrderService,Fr as OrderShippingState,ko as PermissionKeys,q as PhoneEditor,ft as ProductColumns,Ve as ProductDialog,Me as ProductForm,Ht as ProductGrid,se as ProductLangRow,qo as ProductLangService,ce as ProductLogRow,S as ProductRow,Re as ProductService,ht as RegionColumns,We as RegionDialog,He as RegionForm,Gt as RegionGrid,M as RegionRow,vt as RegionService,or as SalesByCategoryColumns,me as SalesByCategoryRow,Uo as SalesByCategoryService,gt as ShipperColumns,$e as ShipperDialog,Ge as ShipperForm,dt as ShipperFormatter,Qt as ShipperGrid,H as ShipperRow,xt as ShipperService,Dt as SupplierColumns,De as SupplierDialog,Fe as SupplierForm,Bt as SupplierGrid,O as SupplierRow,yt as SupplierService,St as TerritoryColumns,je as TerritoryDialog,Qe as TerritoryForm,Kt as TerritoryGrid,G as TerritoryRow,Rt as TerritoryService};
