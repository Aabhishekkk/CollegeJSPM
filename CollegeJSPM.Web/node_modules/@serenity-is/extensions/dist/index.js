var ue=Object.defineProperty;var Se=Object.getOwnPropertyDescriptor;var o=(u,r)=>ue(u,"name",{value:r,configurable:!0});var c=(u,r,e,t)=>{for(var i=t>1?void 0:t?Se(r,e):r,a=u.length-1,l;a>=0;a--)(l=u[a])&&(i=(t?l(r,e,i):l(i))||i);return t&&i&&ue(r,e,i),i};var te=(u,r,e)=>new Promise((t,i)=>{var a=n=>{try{s(e.next(n))}catch(m){i(m)}},l=n=>{try{s(e.throw(n))}catch(m){i(m)}},s=n=>n.done?t(n.value):Promise.resolve(n.value).then(a,l);s((e=e.apply(u,r)).next())});import{PasswordEditor as Pe,PrefixedContext as De}from"@serenity-is/corelib";import{initFormType as Re}from"@serenity-is/corelib/q";var F=class extends De{constructor(r){if(super(r),!F.init){F.init=!0;var e=Pe;Re(F,["OldPassword",e,"NewPassword",e,"ConfirmPassword",e])}}},K=F;o(K,"ChangePasswordForm"),K.formKey="Serenity.Extensions.ChangePasswordRequest";import{EmailAddressEditor as Ee,PrefixedContext as we}from"@serenity-is/corelib";import{initFormType as Ie}from"@serenity-is/corelib/q";var q=class extends we{constructor(r){if(super(r),!q.init){q.init=!0;var e=Ee;Ie(q,["Email",e])}}},M=q;o(M,"ForgotPasswordForm"),M.formKey="Serenity.Extensions.ForgotPasswordRequest";import{PasswordEditor as Oe,PrefixedContext as ke}from"@serenity-is/corelib";import{initFormType as Fe}from"@serenity-is/corelib/q";var B=class extends ke{constructor(r){if(super(r),!B.init){B.init=!0;var e=Oe;Fe(B,["NewPassword",e,"ConfirmPassword",e])}}},U=B;o(U,"ResetPasswordForm"),U.formKey="Serenity.Extensions.ResetPasswordRequest";import{fieldsProxy as qe}from"@serenity-is/corelib/q";var g=class{};o(g,"UserPreferenceRow"),g.idProperty="UserPreferenceId",g.nameProperty="Name",g.localTextPrefix="Common.UserPreference",g.deletePermission="",g.insertPermission="",g.readPermission="",g.updatePermission="",g.Fields=qe();import{serviceRequest as Be}from"@serenity-is/corelib/q";var A;(e=>(e.baseUrl="Extensions/UserPreference",e.Methods={Update:"Extensions/UserPreference/Update",Retrieve:"Extensions/UserPreference/Retrieve"},["Update","Retrieve"].forEach(t=>{e[t]=function(i,a,l){return Be(e.baseUrl+"/"+t,i,a,l)}})))(A||(A={}));import{Decorators as Ae,TemplatedDialog as Ve}from"@serenity-is/corelib";import{localText as re,trimToNull as Ne}from"@serenity-is/corelib/q";var C=class extends Ve{constructor(){super();this.dialogTitle=re("Site.BasicProgressDialog.PleaseWait")}get max(){return parseInt(this.byId("ProgressBar").attr("aria-valuemax"),10)}set max(e){this.byId("ProgressBar").attr("aria-valuemax",(e||100).toString())}get value(){return parseInt(this.byId("ProgressBar").attr("aria-valuenow"),10)}set value(e){this.byId("ProgressBar").attr("aria-valuenow",(e||0).toString()).css("width",(e||0)/(this.max||100)*100+"%").text(e+" / "+this.max)}get title(){return this.dialogTitle}set title(e){this.dialogTitle=e}getDialogButtons(){return[{text:re("Dialogs.CancelButton"),class:"btn btn-danger",click:()=>{this.cancelled=!0,this.element.closest(".ui-dialog").find(".ui-dialog-buttonpane .ui-button").attr("disabled","disabled").css("opacity","0.5"),this.element.dialog("option","title",Ne(this.cancelTitle)||re("Site.BasicProgressDialog.CancelTitle"))}}]}getDialogOptions(){var e=super.getDialogOptions();return e.width=600,e}initDialog(){super.initDialog(),this.element.closest(".ui-dialog").find(".ui-dialog-titlebar-close").hide()}getTemplate(){return`<div class="s-DialogContent s-BasicProgressDialogContent">
